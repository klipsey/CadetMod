...
{
    public abstract class BaseMeleeAttack : BaseCadetSkillState, SteppedSkillDef.IStepSetter
    {
        ...
        {
            PlayCrossfade("Gesture, Override", "Slash" + (1 + swingIndex), playbackRateParam, duration, duration * 0.05f);
        }
