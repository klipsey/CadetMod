...
namespace CadetMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        /// <para>If a "HeadCenter" child is also set up, automatically sets that one up and assigns that one as a sniper weakpoint. if not, MainHurtbox is set as a sniper weakpoint.</para>
        /// </summary>
        private static void SetupMainHurtboxesFromChildLocator(GameObject bodyPrefab, GameObject model)
        {
            ...
            GameObject headHurtboxObject = childLocator.FindChildGameObject("HeadCenter");
            if (headHurtboxObject)
            {
                Log.Debug("HeadCenterFound. Setting up");
