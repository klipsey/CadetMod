...
namespace CadetMod.Cadet.SkillStates
{
    ...
    {
        public static float overrideDuration = 0.5f;
        ...
        public override void OnEnter()
        {
            ...
            base.baseDuration = overrideDuration;
            ...
            {
                base.PlayCrossfade("Gesture, Override", "ThrowGun", "Throw.playbackRate", this.duration, this.duration * 0.05f);
            }
        }
