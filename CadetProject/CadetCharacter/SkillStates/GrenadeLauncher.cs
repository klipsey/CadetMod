    ...
    public class GrenadeLauncher : GenericProjectileBaseState
    {
        ...
        public override void FireProjectile()
        {
            ...
            if (base.isAuthority)
            {
                ...
                ProjectileManager.instance.FireProjectile(grenade, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), this.gameObject, 
                    this.damageStat * CadetConfig.grenadeDamageCoefficient.Value, this.force, this.RollCrit(), DamageColorIndex.Default, null, -1f);
